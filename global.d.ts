...
declare global {
  ...
  interface Window {
    ...
    YoutubeAntiTranslate: {
      ...
      CORE_ATTRIBUTED_STRING_SELECTOR: string;
      /** "ytd-video-renderer, ytd-rich-item-renderer, ytd-compact-video-renderer, ETC..." */
      ALL_ARRAYS_VIDEOS_SELECTOR: string;
      /** "div.style-scope.ytd-rich-item-renderer, ytm-shorts-lockup-view-model" */
      ALL_ARRAYS_SHORTS_SELECTOR: string;
       ...
       * @param waitMinMs - Minimum time between invocations (ms) - defaults to 90 milliseconds. Default: 90.
      ...
      /**
       * Given a Node Element it uses computed style to determine if it is visible
      ...
      /**
       * Given an Array of NodeListOf<Element>s it returns visible Element or null
       ...
       */
      getFirstVisible: (
        nodes: Element | NodeListOf<Element> | null | undefined,
        shouldBeInsideViewport?: boolean,
      ) => Element | null;

      /**
       * Given an Array of NodeListOf<Element>s it returns visible Elements or null
       * @param nodes - A NodeList or single Node of type ELEMENT_NODE
       * @param shouldBeInsideViewport - Optional. If true the element should also be inside the viewport to be considered visible. Defaults true
      ...
      /**
       * Given an NodeListOf<Element>s it returns visible Elements or null only if they are loaded outside the viewport
       * @param nodes - A NodeList or single Node of type ELEMENT_NODE
       ...
       */
      createLinkElement: (url: string) => Element;
       ...
       */
      createTimecodeLink: (timecode: string) => Element;

      /**
       * Creates a styled link for hashtag or mention
       * @param type - Type of link to create
       * @param value - Hashtag (without #) or mention (without @)
       * @returns - Span element containing the styled link
       */
      createTagLink: (type: "hashtag" | "mention", value: string) => Element;
       ...
       */
      convertUrlsToLinks: (text: string) => Element;
       ...
       */
      createFormattedContent: (text: string) => Element;
       ...
       */
      replaceTextOnly: (element: Element, replaceText: string) => void;
       ...
       */
      getFirstTextNode: (element: Element) => Text | null;
       ...
       * @param search_query - The search query string. Should be `${mainAuthor} ${videoTitle}` to get the most relevant results.
       ...
       */
      extractCollaboratorsItemsFromSearch: (json: any) => Array<{
        name: string | null;
        avatarImage: string | null;
        url: string | null;
        navigationEndpointUrl: string | null;
      ...
      getPlayerResponseSafely: (
        playerEl: Element | null | undefined,
      ) => object | null;
       ...
       * @param element - The HTML element to update the attribute on.
       * @param attributeName - The name of the attribute to update.
       * @param videoId - The video ID to associate with the attempt count.
       */
