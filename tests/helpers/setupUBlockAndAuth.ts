...
import { newPageWithStorageStateIfItExists, handleGoogleLogin, findLoginButton } from "./AuthStorageHelper";
import { downloadAndExtractUBlock } from "./ExtensionsFilesHelper";
import { handleYoutubeConsent } from "./YoutubeConsentHelper";


export async function setupUBlockAndAuth(allBrowserNameWithExtensions: string[], allLocaleStrings: string[]) {
